...
public class CommandSearch extends Command {
    ...
    CommandSearch() {
        super("search", "basketbandit.core.modules.ModuleMusic", null);
    }
    ...
    protected boolean executeCommand(MessageReceivedEvent e) {
        List<SearchResult> results = ModuleMusic.searchYouTubeAux(e);
        ...
        if(results != null) {
            ...
            ModuleMusic.searchUsers.put(e.getAuthor().getIdLong(), results);
