...
public class CommandCurrentTrack extends Command {
    ...
    CommandCurrentTrack() {
        super("currenttrack", "basketbandit.core.modules.ModuleMusic", null);
    }
    ...
    protected boolean executeCommand(MessageReceivedEvent e) {
        ...
        if(manager.player.getPlayingTrack() != null) {
            EmbedBuilder queuedTrack = new EmbedBuilder()
                    ...
                    .addField("Duration", ModuleMusic.getTimestamp(track.getPosition()) + "/" + ModuleMusic.getTimestamp(track.getDuration()), true)
