...
public class PatCommand extends InteractionCommand {
    ...
    public void onCommand(MessageEvent e) {
        ...
        if(target != null) {
            EmbedBuilder embed = new EmbedBuilder().setDescription("**" + e.getMember().getEffectiveName() + "** pats **" + target.getEffectiveName() + "**.").setImage(interactionImage.get(random(interactionImage.size())));
