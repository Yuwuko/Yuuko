...
public class BackgroundCommand extends Command {
    ...
    public BackgroundCommand() {
        super("background", Yuuko.MODULES.get("audio"), 0, -1L, Arrays.asList("-background", "-background <url>", "-background <term>"), false, Arrays.asList(Permission.VOICE_CONNECT, Permission.VOICE_SPEAK));
    }
