...
public class ModuleLogging extends Module {
    ...
    protected void executeCommand(MessageReceivedEvent e, String[] command) {
        try {
            ...
            Utils.sendMessage(e, String.format("This server has logging enabled but has no 'command-log' text channel, please add that channel or disable the module by typing the '%s module logging' command to stop this message.", Configuration.GLOBAL_PREFIX));
        }
    }
}
