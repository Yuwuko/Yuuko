...
public class CommandWeather extends Command {
    ...
    protected void executeCommand(MessageReceivedEvent e, String[] command) {
        try {
            ...
            String json = new JsonBuffer().getString("api.openweathermap.org/data/2.5/weather?q=" +commandParameters[0] + "&APPID=" + Configuration.OPEN_WEATHER_MAP_API);
            ...
            EmbedBuilder embed = new EmbedBuilder()
                    ...
                    .addField("Sunrise", weather.getSys().getSunrise() + "", true)
                    .addField("Sunset", weather.getSys().getSunset() + "", true)
                    .addField("Humidity", weather.getMain().getHumidity() + "", true)
                    .addField("Temperature", weather.getMain().getTemp() + "", true)
                    .addField("Max Temperature", weather.getMain().getTempMax() + "", true)
                    .addField("Min Temperature", weather.getMain().getTempMin() + "", true)
                    .addField("Wind Speed", weather.getWind().getSpeed() + "mph", true)
                    .addField("Wind Angle", weather.getWind().getDeg() + "°", true)
                    .addField("Visibility", weather.getVisibility() + "", true)
