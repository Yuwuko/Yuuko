    ...
    public void executeCommand(MessageReceivedEvent e, String[] command) {
        try {
            ...
            try {
                ...
                EmbedBuilder embed = new EmbedBuilder().setAuthor("Although the user exists, they haven't played and thus have no statistics to show.");
                MessageHandler.sendMessage(e, embed.build());
                return;
            }

            EmbedBuilder embed = new EmbedBuilder().setAuthor("Displaying stats for " + user.getUsername() + " on " + modeString);
            MessageHandler.sendMessage(e, embed.build());
