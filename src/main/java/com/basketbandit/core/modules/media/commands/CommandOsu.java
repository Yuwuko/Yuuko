    ...
    public void executeCommand(MessageReceivedEvent e, String[] command) {
        try {
            ...
            try {
                ...
                MessageHandler.sendMessage(e, "Sorry " + e.getAuthor().getAsMention() + ", although that user exists, they have no stats!");
                return;
            }

            MessageHandler.sendMessage(e,"Displaying stats for " + user.getUsername() + " on " + modeString);
